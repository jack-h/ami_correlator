...
function tge_rx_out_core_config(this_block)

  % Revision History:
  %
  %   06-Jan-2015  (18:11 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/jack/work/ami_correlator/ami/ami_correlator/tge_rx_out_core.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('tge_rx_out_core');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('tge_rx_out_core.vhd');
